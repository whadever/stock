...
<div class="row">
	<div class="col-md-12 content-wrap">
		<div class="row" style="border-bottom: 2px solid #2c3e50">
			<p class="page_subtitle" style="font-size: 28px;margin-bottom: 0px;">ALL supplierS</p>
			<p>Status User:</p>
		</div>
		<div class="row" style="margin-top: 20px;">
			<div class="form-group" style="margin-bottom: 20px">
				...
				<?php if($role != 'admin'): ?>
					<a href="<?php echo base_url('supplier/add_supplier') ?>" class="btn btn-primary pull-right">Add supplier</a>
				<?php endif; ?>
			</div>
