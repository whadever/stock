...
<div class="row">
	<div class="col-md-12 content-wrap">
		<div class="row" style="border-bottom: 2px solid #2c3e50">
			<p class="page_subtitle" style="font-size: 28px;margin-bottom: 0px;">DAFTAR SUPPLIER</p>
			<p>Status User:</p>
		</div>
		<div class="row" style="margin-top: 20px;">
			<div class="form-group" style="margin-bottom: 20px">
				...
				<?php if($role == 'admin'): ?>
					<a href="<?php echo base_url('supplier/add_supplier') ?>" class="btn btn-primary pull-right">Input Supplier</a>
				<?php endif; ?>
			</div>
					...
					<?php $i=1; foreach($suppliers as $supplier): ?>
						<tr>
							...
							<td><?php echo $supplier->address ?></td>
						 	<td><a href="<?php echo base_url('supplier/edit_supplier').'/'.$supplier->id?>">Edit</a> | <a onclick="delete_cust(<?php echo $supplier->id ?>)">Delete</a></td>
...
<script>
	...
	function delete_cust(id){
	    ...
	    if (e) {
	        location.replace("<?php echo base_url() ?>" + "supplier/delete_supplier/" + id);
	    } else {
	        // user clicked "cancel"
	    }
	});
