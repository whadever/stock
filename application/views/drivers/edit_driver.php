		...
		<div class="row" style="margin-top: 20px;">
			...
			<table class="table product-table">
				...
				<tr>
					...
					<td style="padding-right: 9%;"><input type="text" name="driver_name" value="<?php echo $drivers->name?>" class="form-control"></td>
				</tr>
				<tr>
					<td class="table_detail"><p class="bebas">ALAMAT DRIVER</p></td>
					<td style="padding-right: 9%;"><input type="text" name="driver_address" value="<?php echo $drivers->address?>" class="form-control"></td>
				</tr>
				<!-- <tr>
				...
				<tr>
					...
					<td style="padding-right: 9%;">
						<div class="fileUpload btn btn-primary">
						    ...
						    <img src="<?php echo base_url().$drivers->photo ?>" alt="<?php echo $drivers->name ?>" width="40"/>
						</div>
					</td>
				</tr>
